...
int write_bed_chunk(char *filepath, uint64_t ncols, uint64_t row_chunk,
                    uint8_t *data, uint64_t *strides)
{
...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 24), // int()(char *, uint64_t, uint64_t, uint8_t *, uint64_t *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // char *
/*  2 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24), // uint64_t
/*  3 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // uint8_t *
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 2), // uint64_t *
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION, 24), // int()(char *, uint8_t)
/*  8 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  9 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 18), // uint8_t
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 11 */ _CFFI_OP(_CFFI_OP_FUNCTION, 25), // void()(uint8_t *, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint8_t *, uint64_t *)
/* 12 */ _CFFI_OP(_CFFI_OP_NOOP, 4),
/* 13 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 14 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 15 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 16 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 17 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 18 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 24),
/* 19 */ _CFFI_OP(_CFFI_OP_NOOP, 4),
/* 20 */ _CFFI_OP(_CFFI_OP_NOOP, 5),
/* 21 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 22 */ _CFFI_OP(_CFFI_OP_POINTER, 23), // char const *
/* 23 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/* 24 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/* 25 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};

static void _cffi_d_read_bed_chunk(uint8_t * x0, uint64_t x1, uint64_t x2, uint64_t x3, uint64_t x4, uint64_t x5, uint64_t x6, uint8_t * x7, uint64_t * x8)
{
  read_bed_chunk(x0, x1, x2, x3, x4, x5, x6, x7, x8);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_read_bed_chunk(PyObject *self, PyObject *args)
{
  uint8_t * x0;
  uint64_t x1;
  uint64_t x2;
  ...
  if (!PyArg_UnpackTuple(args, "read_bed_chunk", 9, 9, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  if (datasize != 0) {
    x8 = ((size_t)datasize) <= 640 ? (uint64_t *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(5), arg8, (char **)&x8,
            datasize, &large_args_free) < 0)
      return NULL;
  }
...
#else
#  define _cffi_f_read_bed_chunk _cffi_d_read_bed_chunk
#endif

static int _cffi_d_write_bed_chunk(char * x0, uint64_t x1, uint64_t x2, uint8_t * x3, uint64_t * x4)
{
  return write_bed_chunk(x0, x1, x2, x3, x4);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_write_bed_chunk(PyObject *self, PyObject *args)
{
  char * x0;
  uint64_t x1;
  uint64_t x2;
  ...
  if (!PyArg_UnpackTuple(args, "write_bed_chunk", 5, 5, &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = write_bed_chunk(x0, x1, x2, x3, x4); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
#else
#  define _cffi_f_write_bed_chunk _cffi_d_write_bed_chunk
#endif

static int _cffi_d_write_bed_header(char * x0, uint8_t x1)
{
  return write_bed_header(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_write_bed_header(PyObject *self, PyObject *args)
{
  char * x0;
  uint8_t x1;
  Py_ssize_t datasize;
  ...
  if (!PyArg_UnpackTuple(args, "write_bed_header", 2, 2, &arg0, &arg1))
    return NULL;
...
#else
#  define _cffi_f_write_bed_header _cffi_d_write_bed_header
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "read_bed_chunk", (void *)_cffi_f_read_bed_chunk, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 11), (void *)_cffi_d_read_bed_chunk },
  { "write_bed_chunk", (void *)_cffi_f_write_bed_chunk, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_write_bed_chunk },
  { "write_bed_header", (void *)_cffi_f_write_bed_header, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 7), (void *)_cffi_d_write_bed_header },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_bed_reader(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_bed_reader(void) { return NULL; }
#  else
     initbed_reader(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_bed_reader(void)
{
  return _cffi_init("pandas_plink.bed_reader", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initbed_reader(void)
{
  _cffi_init("pandas_plink.bed_reader", 0x2601, &_cffi_type_context);
}
#endif
